...
//
//        // Game Over text
//        m_gameOverText.setFont(fonts.get(FontID::Main));
...
//        {
//            m_titleText.setFont(fonts.get(FontID::Main));
...
//    {
//        const auto& stats = GameStats::getInstance();
//        float startY = m_game.getWindow().getSize().y * 0.35f;
//        float spacing = 40.0f;
//
...
//    {
//        auto& fonts = m_game.getFonts();
//        sf::Vector2f windowSize(static_cast<float>(m_game.getWindow().getSize().x),
...
//                m_game.clearStates();
//                m_game.pushState(StateID::Play);
//            }},
//            {"Main Menu", [this]() {
//                m_isTransitioning = true;
//                m_game.clearStates();
//                m_game.pushState(StateID::Menu);
//            }},
//            {"Exit", [this]() {
//                m_isTransitioning = true;
...
//
//                // Setup text
//                item.textObject.setFont(fonts.get(FontID::Main));
...
//        sf::Text statText;
//
//        statText.setFont(fonts.get(FontID::Main));
...
//        text.setPosition(static_cast<float>(m_game.getWindow().getSize().x) * 0.5f, yPosition);
//    }
//
